...
/**
 * KD-Tree-based implementation of GraphBuilder.
 *
 * Builds a graph by connecting each location to its N nearest neighbors using spatial indexing.
 */
public class KDTreeGraphBuilder implements GraphBuilder {
